...
Le premier graphe est un grouped bar chart, afin de voir la repartition des valeurs pour chaque tonalité. Les deux autres graphes sont des boxplots, afin de voir la repartition de la tonalité pour les valeurs extremes (en dessous de 3 minutes et au dessus de 10 minutes).
