...
```
graphe_11_a <- data.frame(avg_Tempo[1], avg_Valence[2], avg_Liveness[2], avg_Instrumentalness[2], avg_Acousticness[2], avg_Speechiness[2]ed, avg_Energy[2], avg_danceability[2])
head(df)
